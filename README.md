...
| **HTML 编辑模式** | v7.2 新增 — 右上角开关一键进入编辑，点击任意文字直接修改，保存后可导出 HTML/PPTX |
...
| **v7.2 编辑模式** | ✅ 右上角开关 → 点击文字直接修改 → 保存导出 | ✅ PowerPoint 直接编辑 |
| 离线演示 | 需提前打开网页 | 无需网络 |

选择建议：需要在线演示或部署 → HTML；需要发给领导二次修改 → PPTX 或 HTML 编辑模式导出。
</details>
